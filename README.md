...
当前正式版本：**v0.3.7**。新增已有 Clash / Mihomo YAML 的直接粘贴与文件导入。首次访问会打开全套“新手模式”，通过六步弹窗完成网络模式、代理链接、常用服务、可选网站分流、可选内网 DNS 和最终转换；页头按钮可随时重新打开。发布证据见[v0.3.7 正式发布记录](docs/RELEASE_v0.3.7.md)。
