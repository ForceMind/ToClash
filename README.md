...
当前代码版本：**v0.3.6**。首次访问会打开全套“新手模式”，通过六步弹窗完成网络模式、代理链接、常用服务、可选网站分流、可选内网 DNS 和最终转换；页头按钮可随时重新打开。[打开 v0.3.6 Pages 预览](https://preview-v0-3-6-beginner-mode.to-clash.pages.dev/)；已发布的 v0.3.3 详见[版本说明](docs/RELEASE_v0.3.3.md)。
